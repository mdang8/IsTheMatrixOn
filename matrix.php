<?php
	$html = file_get_contents('http://tvschedule.zap2it.com/tvlistings/ZCGrid.do?aid=tvschedule');

	if (strpos($html, "The Matrix") !== false) {
		$matrix_on = "true";
	} else {
		$matrix_on = "false";
	}
...
<html>
	<head>
		<title>Is The Matrix On?</title>
		<meta name="viewport" content="width=device-width, initial-scale=1.0">
		<link type="text/css" rel="stylesheet" href="TheMatrixCheck/css/stylesheetMatrixCheck.css"/>
		...
		<!--<script src="TheMatrixCheck/js/matrixChecker.js"></script>-->
	</head>
	<body>
		<div id="loadingDiv">
			<img id="loadingAnim" src="TheMatrixCheck/img/loadingAnim.gif" height="64" width="64">
		</div>
		<div id="responseDiv">
			<div id="statusDiv"></div>
			<div id="responseGifDiv"></div>
		</div>
		<div id="otherTextDiv"></div>
		<div id="searchForShow">
			<h3>Search for another show:</h3>
			<input type="text" id="searchShow">
			<input type="submit" onclick="checkForTheMatrix(false)" value="Search">
		</div>
		<p id="howItWorks"><a href="javascript:howWork()">How does this work?</a></p>
	</body>
	<script>
        ...
        function checkForTheMatrix(searchForTheMatrix) {
            ...
            getListings(function(contents) {
                ...
                if (searchForTheMatrix) {  // conditional for if the inputted show is 'The Matrix'
                    ...
                    if (isShowOn == "true") {  // conditional for if 'The Matrix' is showing on TV
